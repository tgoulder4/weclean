...
const ActivityScreen = () => {
  return (
    <Screen title="Activity" subtitle={subtitle}>
      ...
      <ActivityEvent task={{ summary: "Completed Tye's task", type: "Courtesy", completionTime: "2m" }} usersWhoMadeRequest={[{ name: "Tye", profileBackgroundColour: "indigo-500" }]} user={{ name: "Mateusz" }} />
      {
        // olderEvents?.map
      }
