...
const ActivityScreen = () => {
  return (
    <Screen title="Activity" subtitle={subtitle}>
      ...
      <Incentive ctaImpact='heavy' shadow={true} backgroundColor="slate-900" buttonColor='white' ctaButtonText='GO PRO →' description="We get it, it's a pain. Create a rota in seconds with pro, boosting your crew's productivity." mainText='Messy housemates?' ctaAction={createTwoButtonAlert} />
