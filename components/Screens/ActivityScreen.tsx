...
const ActivityScreen = () => {
  ...
  return (
    <Screen title="Activity" subtitle={subtitle}>
      ...
      <View className='bg-indigo-500 flex flex-col' style={{ rowGap: spacing.gaps.smaller }}>
      ...
      <View className='bg-yellow-500 flex flex-col' style={{ rowGap: spacing.gaps.smaller }}>
