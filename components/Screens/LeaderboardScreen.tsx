...
function promptShouldBePro() {
    Alert.alert("Competitions are for pro crews only.", "Enter and enjoy many other perks with Pro.", [
        {
            text: "Not now",
...
const LeaderboardScreen = () => {
    return (
        <Screen title="Leaderboard" subtitle="Cleanest crews ranked by crew score and popularity.">
            <Incentive ctaImpact='medium' legend="This month's competition:" shadow={true} backgroundColor="[#310973]" buttonColor='white' ctaButtonText='Enter →' description="Submit a photo of your clean kitchen every day for a month for a chance to win!" mainText='Cleanest kitchen wins £1,000!' ctaAction={promptShouldBePro} />
