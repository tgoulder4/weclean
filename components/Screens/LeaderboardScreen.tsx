...
const LeaderboardScreen = () => {
    return (
        <Screen title="Leaderboard" subtitle="Cleanest crews ranked by crew score and popularity.">
            <Incentive ctaImpact='medium' legend="This month's competition:" shadow={true} backgroundColor="[#310973]" buttonColor='white' ctaButtonText='ENTER →' description="Submit a photo of your clean kitchen every day for a month for a chance to win!" mainText='Cleanest kitchen wins £1,000!' ctaAction={() => { }} />
