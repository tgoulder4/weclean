            ...
            <ScrollView className='bg-[#080808] border-2 flex-1  gap-y-4'>
                <View className='px-2 pt-28'>
                    ...
                    <Text className='font-afa text-white mb-[20px]'>
                        This competition is Pro-Only. Enjoy this feature and many more with Pro.
                    </Text>
                    <Pod backgroundColour={`[${foregroundColour}]`} noStroke={true} >
                        <View className='flex flex-col'>
                            <ProPerk perkIcon="🧼" perkTitle='Monthly Cleaning Supplies' perkText="Never run low again with cleaning supplies straight to your door" />
                            ...
                            <ProPerk perkIcon="👥" perkTitle="Join multiple crews" perkText="Moving between shared spaces" />
                        </View>
                    </Pod>
                    <Text className='font-afa text-center text-white mb-[20px]'>
                        From £2.49/month. Cancel anytime without hidden fees or penalties.
                    </Text>
                </View>
